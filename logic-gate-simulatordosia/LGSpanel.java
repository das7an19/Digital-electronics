	...
	public LGSpanel() {
		...
		addMouseMotionListener(new MouseMotionAdapter() {
			...
			public void mouseMoved(MouseEvent e) {
				...
				case 3:
					if(alreadyDrawn==false){
						tempComp = new OrGate(e.getX(),e.getY(),0,0);
						circuitComponents.getFirst().myStaticID--;
						add(tempComp);
						tempComp.setVisible(true);
						alreadyDrawn=true;
				...
				case 4:
					if(alreadyDrawn==false){
						tempComp = new NorGate(e.getX(),e.getY(),0,0);
						circuitComponents.getFirst().myStaticID--;
						add(tempComp);
						tempComp.setVisible(true);
						alreadyDrawn=true;
				...
				case 5:
					if(alreadyDrawn==false){
						tempComp = new AndGate(e.getX(),e.getY(),0,0);
						circuitComponents.getFirst().myStaticID--;
						add(tempComp);
						tempComp.setVisible(true);
						alreadyDrawn=true;
				...
				case 6:
					if(alreadyDrawn==false){
						tempComp = new NandGate(e.getX(),e.getY(),0,0);
						circuitComponents.getFirst().myStaticID--;
						add(tempComp);
						tempComp.setVisible(true);
						alreadyDrawn=true;
				...
				case 7:
					if(alreadyDrawn==false){
						tempComp = new XorGate(e.getX(),e.getY(),0,0);
						circuitComponents.getFirst().myStaticID--;
						add(tempComp);
						tempComp.setVisible(true);
						alreadyDrawn=true;
				...
				case 8:
					if(alreadyDrawn==false){
						tempComp = new NXorGate(e.getX(),e.getY(),0,0);
						circuitComponents.getFirst().myStaticID--;
						add(tempComp);
						tempComp.setVisible(true);
						alreadyDrawn=true;
		...
		setBackground(new Color(Integer.parseInt( "458B74",16)));
...
protected void refresh() {
	...
	for(int h =0;h<circuitComponents.size() ;h++){
		for(int i =0;i<circuitComponents.size() ;i++){
			if(circuitComponents.get(i) instanceof LogicGate){
...
for(int h =0;h<circuitComponents.size() ;h++){
	for(int i =0;i<circuitComponents.size() ;i++){
		if(circuitComponents.get(i).outputFlag==1 && circuitComponents.get(i) instanceof LogicGate && 
		 ...
		 if(circuitComponents.get(i).inputFlag==2 &&  circuitComponents.get(i) instanceof LogicGate
				 && circuitComponents.get(h).outputFlag==1
				 && ((circuitComponents.get(h) instanceof LogicGate)|| (circuitComponents.get(h) instanceof Input))){
			 circuitComponents.get(i).setInput2(circuitComponents.get(h).getOutput());
			 circuitComponents.get(i).setInputLoc2(h);
			 drawLines();
		}
		 if(circuitComponents.get(i).inputFlag==1 &&  circuitComponents.get(i) instanceof LogicGate 
				 && circuitComponents.get(h).outputFlag==1 
				 && ((circuitComponents.get(h) instanceof LogicGate)|| (circuitComponents.get(h) instanceof Input))){
...
private void deleteComponent(int nTh) {
	...
	public void clear(){
	    graphics2D.setPaint(new Color(Integer.parseInt( "458B74",16)));
